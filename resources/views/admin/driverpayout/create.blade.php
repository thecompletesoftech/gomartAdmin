...
@section('content')
    @include('admin.layouts.components.header', [
        'title' => __('messages.create', ['name' => trans_choice('content.driverpayout', 1)]),
    ])
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex flex-column flex-lg-row">
                        ...
                        <div class="flex-lg-row-fluid me-0 me-lg-20">
                            ...
                            <!--begin::Form-->
                            {!! Form::open(['route' => 'admin.driverpayouts.store', 'method' => 'POST', 'class' => 'form', 'enctype' => 'multipart/form-data']) !!}

                            @include('admin.driverpayout.form')
